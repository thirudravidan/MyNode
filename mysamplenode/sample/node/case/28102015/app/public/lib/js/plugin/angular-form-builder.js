  ...
  angular.module('builder.controller', ['builder.provider']).controller('fbFormObjectEditableController', [
    '$scope', '$injector', function($scope, $injector) {
      ...
      $scope.setupScope = function(formObject) {
        ...
        $scope.$watch('[label, hideOptions, description, placeholder, required, options, validation, preOptions, dependency, functionCall, preForm, preFormList]', function() {
          formObject.label = $scope.label;
          formObject.hideOptions = $scope.hideOptions;
          formObject.description = $scope.description;
          formObject.placeholder = $scope.placeholder;
          formObject.required = $scope.required;
          formObject.options = $scope.options;
          formObject.preOptions = $scope.preOptions;
          formObject.dependency = $scope.dependency;
          formObject.functionCall = $scope.functionCall;
          formObject.preForm = $scope.preForm;
          formObject.preFormList = $scope.preFormList;
        ...
        $scope.dependencyOptions = component.dependencyOptions;
        $scope.preOptionsList = component.preOptionsList;
      ...
      return $scope.data = {
        ...
        backup: function() {
          ...
          return this.model = {
            label: $scope.label,
            hideOptions: $scope.hideOptions,
            description: $scope.description,
            placeholder: $scope.placeholder,
            required: $scope.required,
            optionsText: $scope.optionsText,
            validation: $scope.validation,
            preOptions: $scope.preOptions,
            dependency: $scope.dependency,
            functionCall: $scope.functionCall,
            preForm: $scope.preForm,
            preFormList: $scope.preFormList,
          };
        },
        rollback: function() {
          ...
          $scope.hideOptions = this.model.hideOptions;
          $scope.description = this.model.description;
          $scope.placeholder = this.model.placeholder;
          $scope.required = this.model.required;
          $scope.optionsText = this.model.optionsText;
          $scope.preOptions = this.model.preOptions;
          $scope.dependency = this.model.dependency;
          $scope.functionCall = this.model.functionCall;
          $scope.preForm = this.model.preForm;
          $scope.preFormList = this.model.preFormList;
    ...
    '$scope', '$injector', '$filter', function($scope, $injector, $filter) {
      var $builder, $timeout;
      $builder = $injector.get('$builder');
      ...
      $scope.callmethodForm = function(selection,  list) {
        var value = $filter('filter')(list, {_id:selection.emailTemplate})[0];
        $scope.emailResponse = value.eMessage != null ? value.eMessage : '';
        selection.inputText = $scope.emailResponse;
        $scope.input[selection.index] = {id:selection.id, label:selection.label, value:$scope.emailResponse};
      };
    ...
    '$scope', '$injector', function($scope, $injector) {
      ...
      $scope.datetimepicker = function (id){
        try {
            //$('#'+id).datepicker('show', { format: 'mm/dd/yyyy' });
            $('#'+id).datetimepicker({
              //language:  'fr',
              weekStart: 1,
              todayBtn:  1,
...
(function() {
  angular.module('builder.directive', ['builder.provider', 'builder.controller', 'builder.drag', 'validator']).directive('fbBuilder', [
    ...
    '$injector', '$filter', function($injector, $filter) {
      ...
      return {
        ...
        link: function(scope, element) {
          ...
          scope.popover = {
            ...
            loadForm: function(optionEvent) {

              /*
              Predefined options list for the Dropdowns
              */
              scope.optionsVal = $filter('filter')(optionEvent.preOptionsList, {id:optionEvent.preOptions})[0];
              optionEvent.placeholder = 'Select '+scope.optionsVal.label;
              optionEvent.label = scope.optionsVal.label;
            },
            loadDependency: function(dependencyEvent) {

              /*
              Predefined Dependency list for the Dropdowns
              */
              if(dependencyEvent.showOptions === '1') { //Add options for the hide show value
                dependencyEvent.options = [{id:true, label:'Yes'}, {id:false, label:'No'}];
              } else {
                dependencyEvent.options = [];
              }
            },
          };
...
(function() {
  ...
  angular.module('builder.provider', []).provider('$builder', function() {
    ...
    this.convertComponent = function(name, component) {
      var result, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17;
      result = {
        name: name,
        ...
        preOptions: (_ref10 = component.preOptions) != null ? _ref10 : '',
        preOptionsList: (_ref11 = component.preOptionsList) != null ? _ref11 : [],
        dependency: (_ref12 = component.dependency) != null ? _ref12 : '',
        dependencyOptions: (_ref13 = component.dependencyOptions) != null ? _ref13 : [],
        functionCall: (_ref14 = component.functionCall) != null ? _ref14 : '',
        preForm: (_ref15 = component.preForm) != null ? _ref15 : '',
        preFormList: (_ref16 = component.preFormList) != null ? _ref16 : '',
        hideOptions: (_ref17 = component.hideOptions) != null ? _ref17 : '',
    ...
    this.convertFormObject = function(name, formObject) {
      ...
      result = {
        ...
        preOptions: (_ref8 = formObject.preOptions) != null ? _ref8 : component.preOptions,
        dependency: (_ref9 = formObject.dependency) != null ? _ref9 : component.dependency,
        functionCall: (_ref10 = formObject.functionCall) != null ? _ref10 : component.functionCall,
        preForm: (_ref11 = formObject.preForm) != null ? _ref11 : component.preForm,
        preFormList: (_ref12 = formObject.preFormList) != null ? _ref12 : component.preFormList,
        hideOptions: (_ref13 = formObject.hideOptions) != null ? _ref13 : component.hideOptions,
      };
      return result;
    };
    ...
    this.registerComponent = (function(_this) {
      return function(name, component) {
        ...
        @param component: The component object.
            ...
            preOptionsList: {array} [{rule: angular-validator, label: 'option label'}] the options for the validation. (default is [])
