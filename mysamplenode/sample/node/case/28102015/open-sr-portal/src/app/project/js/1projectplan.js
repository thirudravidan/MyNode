...
function getROWSET(phaseId) {
    ...
    switch (phaseId) {
      ...
      { 'id': 'name', 'ishideshow': true, 'name': 'Task Description', 'type': 'text', 'visibility': true, 'editable': true, 'customHTML': '<div class="(#=obj.isParent()?\'exp-controller expcoll exp\':\'exp-controller\'#)" align="center"></div><input type="text" name="name" value="(#=obj.name#)" title="(#=obj.name#)">', 'customHeaderHTML': '', 'tdData': [], 'dvalue': '', 'splclass': 'indentCell', 'editableRegion': 'span.editablearea', 'options': '', 'style': 'width:200px;padding-left:(#=obj.level*10#)px;', 'resizable': true, 'celltype': '', 'align': '', 'storage': 'string' },
      ...
      { 'id': 'depends', 'ishideshow': true, 'name': 'Predecessors', 'type': 'text', 'visibility': true, 'editable': true, 'customHTML': '', 'customHeaderHTML': '', 'tdData': [{ 'condition': '(#=obj.hasExternalDep?"readonly":""#)'}], 'dvalue': '', 'splclass': '', 'editableRegion': '', 'options': '', 'style': 'width:100px;', 'resizable': false, 'celltype': '', 'align': '', 'storage': 'string' },
      ...
      { 'id': 'name', 'ishideshow': true, 'name': 'Task Description', 'type': 'text', 'visibility': true, 'editable': true, 'customHTML': '<div class="(#=obj.isParent()?\'exp-controller expcoll exp\':\'exp-controller\'#)" align="center"></div><input type="text" name="name" value="(#=obj.name#)" title="(#=obj.name#)">', 'customHeaderHTML': '', 'tdData': [], 'dvalue': '', 'splclass': 'indentCell fixcol', 'editableRegion': 'span.editablearea', 'options': '', 'style': 'width:200px;padding-left:(#=obj.level*10#)px;', 'resizable': true, 'celltype': '', 'align': '', 'storage': 'string' },
